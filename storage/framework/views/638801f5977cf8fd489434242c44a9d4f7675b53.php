...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-slate-200 rounded-xl p-8 w-96 mx-auto my-24">
        ...
        <div id="modalTitle" class="text-2xl pb-4 border-b-2 border-blue-200 text-blue-600 font-bold">Signup</div>
        ...
        <form name="form" method="POST" action="/signup">
            ...
            <input name="name" id="name" type="text" placeholder="Name" class="h-8 w-full text-lg p-1 border-solid border-2 rounded-md border-blue-500 hover:border-blue-400" value="<?php echo e(old('name')); ?>"></input>
...
unset($__errorArgs, $__bag); ?>
            <button type="button" id="loginActive" value="1" class="text-blue-600 mt-4 p-2 border-b-2 w-24 border-blue-600 font-bold hover:text-blue-400"><a href="loginuser">Login</a></button>
            <button type="submit" id="enterBtn" class="text-white bg-blue-600 p-2 px-4 rounded-md shadow-xl w-24 font-bold hover:shadow-none hover:bg-blue-400 transition-colors ml-8">Sign Up</button>
        </form>
...
<?php endif; ?>
<?php /**PATH C:\Users\hdahmed\Desktop\Software Portfolio\Laravel\Practice\resources\views/loginSignupPage.blade.php ENDPATH**/ ?>